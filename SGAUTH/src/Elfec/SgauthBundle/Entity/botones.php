...
class botones
{
     ...
     * @var \Elfec.botones
     *
     * @ORM\ManyToOne(targetEntity="Elfec.botones")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Elfec.menuOpciones
     *
     * @ORM\ManyToOne(targetEntity="Elfec.menuOpciones")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToMany(targetEntity="Elfec.perfiles", mappedBy="idBoton")
     */
    private $idPerfil;
