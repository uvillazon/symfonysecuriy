 ...
 */
Ext.define("App.View.UsuariosApp.Principal", {
    ...
    CargarComponentes: function () {
        var me = this;
        me.grid = Ext.create('App.View.UsuariosApp.GridUsuarios', {
            width: '100%',
            region: 'center',
        ...
        me.gridAplicaciones = Ext.create("App.View.UsuariosApp.GridAreas", {
            width: '100%',
            itemId: 'gridUsrArea',
            cargarStore: false
        });
