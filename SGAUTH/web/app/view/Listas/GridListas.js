...
Ext.define("App.View.Listas.GridListas", {
    ...
    initComponent: function () {
        ...
        me.columns = [
            ...
            { header: "Tamaño <br>Limite", width: 100, sortable: true, dataIndex: "tam_limite" },
            { header: "Tipo Valor", width: 100, sortable: true, dataIndex: "tipo_valor" },
            { header: "Mayus Minus", width: 100, sortable: true, dataIndex: "mayus_minus" },
