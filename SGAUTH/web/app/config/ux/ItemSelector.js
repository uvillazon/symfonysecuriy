 ...
 */
Ext.define('App.Config.ux.ItemSelector', {
    extend: 'App.Config.ux.MultiSelect',
    alias: ['widget.itemselectorfield', 'widget.itemselector'],
    alternateClassName: ['App.config.ux.ItemSelector'],
    requires: [
        'Ext.button.Button',
        'App.Config.ux.MultiSelect'
    ],
    ...
    createList: function (title) {
        ...
        return Ext.create('App.Config.ux.MultiSelect', {
