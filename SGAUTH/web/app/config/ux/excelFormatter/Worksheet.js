 ...
 */
Ext.define("App.Config.ux.excelFormatter.Worksheet", {
    ...
    constructor: function (store, config) {
        ...
        App.Config.ux.excelFormatter.Worksheet.superclass.constructor.apply(this, arguments);
    },
    ...
    buildCell: function (value, type, style) {
        ...
        return new App.Config.ux.excelFormatter.Cell({
