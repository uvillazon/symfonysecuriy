...
Ext.define('App.Config.ux.GMapPanelv02', {

    extend: 'Ext.panel.Panel',
    alias: 'widget.gmappanelv02',
    ...
    */
    ...
    initComponent: function () {
        ...
        */
        ...
        App.Config.ux.GMapPanelv02.superclass.initComponent.call(this);
        ...
        if (window.google && window.google.maps) {
            ...
            //this.buildScriptTag('Scripts/MarkerWithLabel.js');
            //this.sleep(10000);
            //alert(b);

            //Ext.Msg.alert("Error", "Existe algun problema al conectarse a google maps...");
            //return false;
            //alert("entro");
            //window.gmapapiready = this.apiReady.createDelegate(this);
            //this.buildScriptTag('https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false');
            //this.apiReady();
            //this.loadScript();
            //App.Config.ux.GMapPanelv02.superclass.initComponent.call(this);
            //this.apiReady();
    ...
    loadScript: function () {
        ...
        //document.write('<script type="text/javascript" src="Scripts/MarkerWithLabel.js"></script>');
    },
    apiReady: function () {
        ...
        if (this.rendered) {
            ...
            Ext.defer(function () {
                ...
                google.maps.event.addListener(this.getMap(), 'dragend', Ext.Function.bind(this.dragEnd, this)); //getMap
                google.maps.event.addListener(this.getMap(), 'click', Ext.Function.bind(this.clickEvent, this));
                // google.maps.event.addListener(this.getMap(), 'dragend', Ext.Function.bind(this.dragEnd, this));
                // google.maps.event.addListener(this.getMap(), 'click', Ext.Function.bind(this.getMap, this));
    ...
    afterRender: function () {
        ...
        Ext.applyIf(this, wh);
        App.Config.ux.GMapPanelv02.superclass.afterRender.call(this);
    ...
    getMarker: function () { return this.punto; },
    // private
    buildScriptTag: function (filename, callback) {
        ...
        //script1.src = "Scripts/MarkerWithLabel.js";
        ////document.write('<script type="text/javascript" src="Scripts/MarkerWithLabel.js"></script>');
        //return head.appendChild(script1);
    ...
    onResize: function (w, h) {
        ...
        App.Config.ux.GMapPanelv02.superclass.onResize.call(this, w, h);
    ...
    setSize: function (width, height, animate) {
        ...
        App.Config.ux.GMapPanelv02.superclass.setSize.call(this, width, height, animate);
    ...
    */
    ...
    hideMarkers: function () {
        //alert("asdasd");
        //this.gmap.setAllMap(null);
        //this.clearMarkers();
        Ext.each(this.markers, function (mrk) {
            //alert(mrk);
            mrk.setMap(null);
        });
    },
